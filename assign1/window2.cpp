...
void checkCell(bool array[20][40])
{
   ...
   for (int i = 0; i < height ; i++)
   {
      ...
      {
         if ( (i+1) < height && array[i + 1][j] == true )
	 {
	    count++;
	 }
	 ...
	 if ( (i+1) < height && (j+1) < width && array[i+1][j+1] == true )
	 {
	    count++;
	 }
	 if ( (i+1) < height && (j-1) >= 0 && array[i+1][j-1] == true )
	 {
	    count++;
	 }
	 if ( (i-1) >= 0 && (j+1) < width && array[i-1][j+1] == true )
	 {
	    count++;
	 }
