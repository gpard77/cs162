 ...
 *  The_Shadow Class. It inherits from Fantasy_Man
 **********************************************************/
#include <iostream>
#include <cstdlib>
#include <ctime>
#include "The_Shadow.hpp"
...
The_Shadow::The_Shadow(int strengthIn, int armorIn, std::string nameIn) : Fantasy_Man(12, 0, "The Shadow")
{
   this->strength = 12;
   this->armor = 0;
   this->name = "The Shadow";
 ...
 ******************************************************************/
void The_Shadow::damage(Fantasy_Man * thing1, Fantasy_Man * thing2)
{
